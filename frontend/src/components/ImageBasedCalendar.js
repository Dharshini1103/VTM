...
import { Calendar, Badge, Modal, Typography, Space, Tag, Button, Divider, Card, List, Avatar } from 'antd';
import { 
  CalendarOutlined, ClockCircleOutlined, VideoCameraOutlined, 
  PhoneOutlined, TeamOutlined, GoogleOutlined, UserOutlined,
  EnvironmentOutlined, DoubleRightOutlined
} from '@ant-design/icons';
import dayjs from 'dayjs';

const { Title, Text, Paragraph } = Typography;

function ImageBasedCalendar({ meetings, onDateSelect, onMeetingClick }) {
  ...
  return (
    <div className="image-based-calendar">
      <div className="calendar-header">
        <div className="calendar-title">
          <Title level={4} style={{ margin: 0 }}>
            <CalendarOutlined /> Meeting Calendar
          </Title>
        </div>
        <div className="calendar-actions">
          <Space>
            <Button icon={<DoubleRightOutlined />} size="small">
              Today
            </Button>
...
export default ImageBasedCalendar;
